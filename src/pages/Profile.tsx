    ...
    return (
      <Layout>
        <div className="space-y-6 max-w-2xl">
          ...
          {/* Profile header card skeleton with avatar + stats */}
          <Card className="overflow-hidden">
            <div className="h-20 bg-gradient-to-r from-primary/20 via-accent/15 to-primary/10 shimmer" />
            <CardContent className="-mt-10 space-y-4">
              <div className="flex items-end gap-4">
                <Skeleton className="h-20 w-20 rounded-full ring-4 ring-background shimmer" />
          ...
          <Card>
            <CardHeader><Skeleton className="h-5 w-40 shimmer" /></CardHeader>
          ...
          {/* Chart placeholder */}
          <Card>
            <CardHeader><Skeleton className="h-5 w-36 shimmer" /></CardHeader>
            <CardContent>
              <div className="flex items-end justify-around gap-2 h-32">
                {[60, 80, 45, 90, 70].map((h, i) => (
                  <Skeleton key={i} className="w-full rounded-t shimmer" style={{ height: `${h}%` }} />
                ))}
              </div>
            </CardContent>
          </Card>
          ...
          {/* Track rows skeleton */}
          <Card>
            <CardHeader><Skeleton className="h-5 w-32 shimmer" /></CardHeader>
            <CardContent className="space-y-3">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-center justify-between p-3 border border-border/60 rounded-lg">
                  ...
                  <Skeleton className="h-6 w-20 rounded-full shimmer ml-3" />
                </div>
              ))}
            </CardContent>
          </Card>
