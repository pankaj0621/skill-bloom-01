                ...
                <Card className="flex-1 overflow-auto">
                  <CardContent className="p-4 space-y-4">
                    ...
                    {targetLevels.length === 0 ? (
                      ...
                      <>
                        <h2 className="text-base md:text-lg font-semibold">Recommended Seniors</h2>
                ...
                <Card className="flex-1 flex flex-col">
                        ...
                        {messages.map((msg) => {
                          ...
                          return (
                            <div key={msg.id} className={`flex ${isMine ? "justify-end" : "justify-start"}`}>
                              <div className={`max-w-[80%] md:max-w-[70%] rounded-2xl px-3 py-2 text-sm ${
                                isMine
                  ...
                  <div className="border-t p-2 md:p-3 flex gap-2">
                    <Input
                      ...
                      className="text-sm"
                    />
                    <Button size="icon" onClick={() => sendMessage.mutate()} disabled={!messageText.trim()} className="flex-shrink-0">
